...
<head>
	...
	<title>Metaheuristics CMS | Documents</title>
...
<body class="pace-done {{ $skin }}" data-ng-controller="DocumentController">
	<div class="pace  pace-inactive" data-ng-init="getUserDocuments()">
					...
					<div class="col-lg-11 animated fadeInRight">
						<div class="mail-box-header">
							...
							<div class="pull-right tooltip-demo">
								...
								<a class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Document" href="javascript:void(0)"
									data-ng-click="editPage(document)"><i class="fa fa-edit"></i> Edit Document</a>
								<a class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Document Info" href="javascript:void(0)"
									data-ng-click="showDocInfo(document)"><i class="fa fa-info"></i> Document Info</a>
							...
							<div class="ibox-content">
								...
								<div class="row">
									...
									<div class="col-md-7">
										...
										<a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#myModal4"><i class="fa fa-cogs"></i> Set Viewership</a>
